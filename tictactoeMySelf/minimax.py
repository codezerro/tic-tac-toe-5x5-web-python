...
# state[25][25] = 0
# winList = [
#     [mBoard[0][0], mBoard[1][1], mBoard[2][2], mBoard[3][3], mBoard[4][4]],
#     [mBoard[0][0], mBoard[0][1], mBoard[0][2], mBoard[0][3], mBoard[0][4]],
#     [mBoard[0][0], mBoard[1][0], mBoard[2][0], mBoard[3][0], mBoard[4][0]],
#     [mBoard[0][1], mBoard[1][1], mBoard[2][1], mBoard[3][1], mBoard[4][1]],
#     [mBoard[0][2], mBoard[1][2], mBoard[2][2], mBoard[3][2], mBoard[4][2]],
#     [mBoard[0][3], mBoard[1][3], mBoard[2][3], mBoard[3][3], mBoard[4][3]],
#     [mBoard[0][4], mBoard[1][4], mBoard[2][4], mBoard[3][4], mBoard[4][4]],
#     [mBoard[1][0], mBoard[1][1], mBoard[1][2], mBoard[1][3], mBoard[1][4]],
#     [mBoard[2][0], mBoard[2][1], mBoard[2][2], mBoard[2][3], mBoard[2][4]],
#     [mBoard[3][0], mBoard[3][1], mBoard[3][2], mBoard[3][3], mBoard[3][4]],
#     [mBoard[4][0], mBoard[4][1], mBoard[4][2], mBoard[4][3], mBoard[4][4]],
#     [mBoard[0][4], mBoard[1][3], mBoard[2][2], mBoard[3][1], mBoard[4][0]]
# ]
